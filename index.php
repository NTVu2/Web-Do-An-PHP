...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Category Grid - Tùy chỉnh dễ dàng */
        :root {
            /* TÙY CHỈNH SỐ LƯỢNG DANH MỤC TRÊN 1 HÀNG */
            --categories-per-row: 4; /* Thay đổi số này để có nhiều hơn/ít hơn danh mục trên 1 hàng */
            --category-min-width: 180px; /* Kích thước tối thiểu của mỗi danh mục */
            --category-gap: 2rem; /* Khoảng cách giữa các danh mục */
            --category-margin-bottom: 3rem; /* Khoảng cách phía dưới grid */
        }

        .category-grid {
            display: grid;
            /* Tùy chỉnh số lượng cột - có thể thay đổi từ 1-12 */
            grid-template-columns: repeat(var(--categories-per-row), 1fr);
            /* Hoặc dùng auto-fit cho responsive tự động */
            /* grid-template-columns: repeat(auto-fit, minmax(var(--category-min-width), 1fr)); */
            gap: var(--category-gap);
            margin-bottom: var(--category-margin-bottom);
        }

        /* Preset cho các layout phổ biến - Bỏ comment để sử dụng */
        ...
        /* Layout 5 cột đều */
        .category-grid.layout-5 {
            grid-template-columns: repeat(5, 1fr);
        }
        
        /* Layout 6 cột đều */
        .category-grid.layout-6 {
            grid-template-columns: repeat(6, 1fr);
        }

        /* Layout responsive tự động */
        .category-grid.layout-auto {
        ...
        @media (max-width: 768px) {
            ...
            .category-grid {
                --categories-per-row: 2; /* Tablet: 2 cột */
                --category-gap: 1.5rem;
            }
        ...
        @media (max-width: 480px) {
            ...
            .category-grid {
                --categories-per-row: 1; /* Mobile: 1 cột */
                --category-gap: 1rem;
            }
        }
    ...
    <header class="lego-header brick-pattern">
        <div class="header-container">
            ...
            <a href="index.php" class="lego-logo">
                <img src="img/sản_phẩm/logo.png" alt="Logo" class="logo-image">
